...
## EXT FIG 4: Comparison with Gompertz model
...
p <- plot_grid(p.row1,
               ...
               ncol = 1)
print(p)
ggsave(paste0(path.output, "EXT_FIG04_logistic_vs_gompertz.png"),
       width = 18, height = 18, units = "cm", bg = "white")
ggsave(paste0(path.output, "EXT_FIG04_logistic_vs_gompertz.svg"),
       width = 18, height = 18, units = "cm", bg = "white")
```
...
p <- plot_grid(p1 + theme(legend.position = "none"),
               ...
               label_size = font.size)
print(p)
ggsave(paste0(path.output, "EXT_FIG05_validation_announcements.png"),
       width = 16, height = 8, units = "cm", bg = "white")
ggsave(paste0(path.output, "EXT_FIG05_validation_announcements.svg"),
       width = 16, height = 8, units = "cm", bg = "white")
```
...
print(p)
ggsave(paste0(path.output, "EXT_FIG06_sensitivity_anticipation_unconventional.png"),
       width = 18, height = 18, units = "cm", bg = "white")
ggsave(paste0(path.output, "EXT_FIG06_sensitivity_anticipation_unconventional.svg"),
       width = 18, height = 18, units = "cm", bg = "white")
...
print(p)
ggsave(paste0(path.output, "EXT_FIG07_capacity_distributions_2025-2050.png"),
       width = 18, height = 14, units = "cm", bg = "white")
ggsave(paste0(path.output, "EXT_FIG07_capacity_distributions_2025-2050.svg"),
       width = 18, height = 14, units = "cm", bg = "white")
...
print(p)
ggsave(paste0(path.output, "EXT_FIG08_comparison_scenarios.png"),
       width = 18, height = 14, units = "cm", bg = "white")
ggsave(paste0(path.output, "EXT_FIG08_comparison_scenarios.svg"),
       width = 18, height = 14, units = "cm", bg = "white")
